...
analysis_tbl = ''  % NO MARKS
save_dir = [BASEPATH filesep 'ExampleOutput' filesep 'nomarks_pulse_analysis_out' filesep];      % Save location      % Save location
...
[ftbl,wtbl,ptbl,dat_tbl] = pulse_analysis_main(data_folder,save_dir,'sds',sds,...
    'FileText',text,'WindowType','All','WindowSize',15,'corr_method','xcorr','cnap','true');
